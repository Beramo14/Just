...
draw_self();
draw_set_font(font0);
draw_text_color(940,350,"돈 : "+string(score),c_orange,c_yellow,c_orange,c_yellow,1);
if(instance_exists(low_class_slave))
{
	draw_text_color(40,40,low_class_slave.s,c_black,c_black,c_black,c_black,1)
	draw_text_color(70,40,instance_number(low_class_slave),c_black,c_black,c_black,c_black,1)
}
